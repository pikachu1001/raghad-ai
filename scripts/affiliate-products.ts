...
function travel(
  ...
  return {
    ...
    descriptionAr: `${nameAr} — احجزي عبر رابط الشريك.`,
    affiliateUrl: url,
    discountCode: null,
...
export const AFFILIATE_PRODUCTS: AffiliateProductSeed[] = [
  ...
  // Fashion
  {
    ...
    descriptionAr: "أزياء وعبايات — استخدمي كود الخصم عند الدفع.",
  ...
  },
  {
    ...
    descriptionAr: "أزياء محتشمة — استخدمي كود الخصم عند الدفع.",
  ...
  // Noon
  {
    ...
    descriptionAr: "تسوقي المنزل ونمط الحياة على نون السعودية.",
  ...
  },
  {
    ...
    descriptionAr: "تسوقي المنزل ونمط الحياة على نون الإمارات.",
